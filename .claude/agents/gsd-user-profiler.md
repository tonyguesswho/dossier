...
<reference>
@/Users/anthony/workspace/ai/dos/.claude/get-shit-done/references/user-profiling.md
...
Read the user-profiling reference document at `/Users/anthony/workspace/ai/dos/.claude/get-shit-done/references/user-profiling.md` to load:
