...
```bash
INIT=$(node "/Users/anthony/workspace/ai/dos/.claude/get-shit-done/bin/gsd-tools.cjs" init phase-op "${PHASE}")
...
Use the SPEC.md template from @/Users/anthony/workspace/ai/dos/.claude/get-shit-done/templates/spec.md.
