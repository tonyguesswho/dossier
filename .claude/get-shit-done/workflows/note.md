...
- **Global scope**: `/Users/anthony/workspace/ai/dos/.claude/notes/{YYYY-MM-DD}-{slug}.md` — fallback when no `.planning/`, or when `--global` flag is present
...
2. Ensure the notes directory exists (`.planning/notes/` or `/Users/anthony/workspace/ai/dos/.claude/notes/`)
...
2. Glob `/Users/anthony/workspace/ai/dos/.claude/notes/*.md` (if directory exists) — global notes
...
Global (/Users/anthony/workspace/ai/dos/.claude/notes/):
...
2. **No `.planning/`**: Falls back to global `/Users/anthony/workspace/ai/dos/.claude/notes/` — works in any directory
