...
<template>
@/Users/anthony/workspace/ai/dos/.claude/get-shit-done/templates/UAT.md
</template>
...
Read and follow `/Users/anthony/workspace/ai/dos/.claude/get-shit-done/workflows/transition.md`.
...
```bash
node "/Users/anthony/workspace/ai/dos/.claude/get-shit-done/bin/gsd-tools.cjs" audit-open --json 2>/dev/null
```
...
- Follow @/Users/anthony/workspace/ai/dos/.claude/get-shit-done/workflows/diagnose-issues.md
