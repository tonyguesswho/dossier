...
```
Task(
  prompt="Read /Users/anthony/workspace/ai/dos/.claude/agents/gsd-nyquist-auditor.md for instructions.\n\n" +
...
**State B (create):**
1. Read template from `/Users/anthony/workspace/ai/dos/.claude/get-shit-done/templates/VALIDATION.md`
