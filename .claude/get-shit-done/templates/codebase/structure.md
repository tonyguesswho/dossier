...
- Usage: Reference from command with `@/Users/anthony/workspace/ai/dos/.claude/get-shit-done/workflows/{name}.md`
...
**get-shit-done/**
- Purpose: Resources installed to /Users/anthony/workspace/ai/dos/.claude/
- Source: Copied by bin/install.js during installation
- Committed: Yes (source of truth)

**commands/**
- Purpose: Slash commands installed to /Users/anthony/workspace/ai/dos/.claude/commands/
- Source: Copied by bin/install.js during installation
- Committed: Yes (source of truth)
